...
@RestController
@RequestMapping("/api/telegram-kafka")
public class TelegramKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TelegramKafkaResource.class);
    ...
    public TelegramKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
